...
.. cpp:class:: File
    ...
    .. cpp:function:: File(MPI_Comm comm, const std::string filename, std::string encoding="ascii")
    ...
    .. cpp:function:: File(MPI_Comm comm, const std::string filename, Type type, std::string encoding="ascii")
