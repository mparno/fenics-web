...
.. cpp:class:: FiniteElement
    ...
    .. cpp:function:: void interpolate_vertex_values(double* vertex_values, double* coefficients, const double* vertex_coordinates, int cell_orientation, const ufc::cell& cell) const
