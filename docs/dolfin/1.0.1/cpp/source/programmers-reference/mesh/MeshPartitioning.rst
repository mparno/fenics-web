...
.. cpp:class:: MeshPartitioning
    ...
    .. cpp:function:: static void build_distributed_mesh(Mesh& mesh, LocalMeshData& data)
    ...
    .. cpp:function:: static void build_mesh_domains(Mesh& mesh, const LocalMeshData& local_data)
    
        Create and attach distributed MeshDomains from local_data


    .. cpp:function:: static void build_mesh_value_collection(const Mesh& mesh, const std::vector<std::pair<std::pair<uint, uint>, T> >& local_value_data, MeshValueCollection& mesh_values)
