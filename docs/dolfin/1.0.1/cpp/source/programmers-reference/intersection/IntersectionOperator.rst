...
.. cpp:class:: IntersectionOperator
    ...
    .. cpp:function:: IntersectionOperator(const MeshFunction<unsigned int>& labels, uint label, const std::string& kernel_type = "SimpleCartesian")
    ...
    .. cpp:function:: IntersectionOperator(boost::shared_ptr<const MeshFunction<unsigned int> > labels, uint label, const std::string& kernel_type="SimpleCartesian")
