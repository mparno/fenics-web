...
.. cpp:class:: PETScFactory
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: PETScLUSolver* create_lu_solver(std::string method) const
    
        Create LU solver


    .. cpp:function:: PETScKrylovSolver* create_krylov_solver(std::string method, std::string preconditioner) const
