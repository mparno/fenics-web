...
.. cpp:class:: Form
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: Form(uint rank, uint num_coefficients)
    ...
    .. cpp:function:: uint coefficient_number(const std::string & name) const
    ...
    .. cpp:function:: std::string coefficient_name(uint i) const
