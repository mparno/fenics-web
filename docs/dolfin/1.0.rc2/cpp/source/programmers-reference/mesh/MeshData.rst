...
.. cpp:class:: MeshData
    ...
    *Parent class(es)*
    ...
    Sub meshes (used by the class SubMesh)
      ...
      * "parent_vertex_indices" - :cpp:class:`MeshFunction` <uint> of dimension 0
    ...
    .. cpp:function:: boost::shared_ptr<std::vector<uint> > create_array(std::string name)
    ...
    .. cpp:function:: boost::shared_ptr<std::vector<uint> > create_array(std::string name, uint size)
    ...
    .. cpp:function:: boost::shared_ptr<std::vector<uint> > array(const std::string name) const
