...
.. cpp:class:: Function
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: Function(const FunctionSpace& V, std::string filename_vector)
    ...
    .. cpp:function:: Function(boost::shared_ptr<const FunctionSpace> V, std::string filename_vector)
