...
.. cpp:class:: BlockVector
    ...
    .. cpp:function:: void set_block(std::size_t i, std::shared_ptr<GenericVector> v)
    
        Set function


    .. cpp:function:: std::shared_ptr<const GenericVector> get_block(std::size_t i) const
    
        Get sub-vector (const)


    .. cpp:function:: std::shared_ptr<GenericVector> get_block(std::size_t)
