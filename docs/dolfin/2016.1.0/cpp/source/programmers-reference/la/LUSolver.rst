...
.. cpp:class:: LUSolver
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: LUSolver(MPI_Comm comm, std::string method= "default")
    ...
    .. cpp:function:: LUSolver(MPI_Comm comm, std::shared_ptr<const GenericLinearOperator> A, std::string method="default")
    
        Constructor


    .. cpp:function:: LUSolver(std::shared_ptr<const GenericLinearOperator> A, std::string method="default")
