...
.. cpp:class:: MeshPartitioning
    ...
    .. cpp:function:: static void build_distributed_mesh(Mesh& mesh, const std::vector<int>& cell_partition, const std::string ghost_mode)
    ...
    .. cpp:function:: static void build_distributed_mesh(Mesh& mesh, const LocalMeshData& data, const std::string ghost_mode)
