...
.. cpp:class:: PETScKrylovSolver
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: void set_operator(std::shared_ptr<const PETScBaseMatrix> A)
    ...
    .. cpp:function:: void set_operators(std::shared_ptr<const PETScBaseMatrix> A, std::shared_ptr<const PETScBaseMatrix> P)
