...
.. cpp:class:: EpetraVector
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: EpetraVector()
    
        Create empty vector


    .. cpp:function:: EpetraVector(MPI_Comm comm, std::size_t N)
    ...
    .. cpp:function:: explicit EpetraVector(std::shared_ptr<Epetra_FEVector> vector)
    ...
    .. cpp:function:: void init(MPI_Comm comm, std::pair<std::size_t, std::size_t> range, const std::vector<la_index>& ghost_indices)
    ...
    .. cpp:function:: void init(const Epetra_BlockMap& map)
    
        Initialize Epetra_FEVector with Epetra map


    .. cpp:function:: std::shared_ptr<Epetra_FEVector> vec() const
