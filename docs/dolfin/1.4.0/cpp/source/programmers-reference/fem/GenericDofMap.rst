...
.. cpp:class:: GenericDofMap
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: std::shared_ptr<const Restriction> restriction() const = 0
    ...
    .. cpp:function:: std::shared_ptr<GenericDofMap> collapse(boost::unordered_map<std::size_t, std::size_t>& collapsed_map, const Mesh& mesh) const = 0
