...
.. cpp:class:: AdaptiveNonlinearVariationalSolver
    ...
    .. cpp:function:: AdaptiveNonlinearVariationalSolver(NonlinearVariationalProblem& problem, GoalFunctional& goal)
    ...
    .. cpp:function:: AdaptiveNonlinearVariationalSolver(std::shared_ptr<NonlinearVariationalProblem> problem, std::shared_ptr<GoalFunctional> goal)
    ...
    .. cpp:function:: AdaptiveNonlinearVariationalSolver(std::shared_ptr<NonlinearVariationalProblem> problem, std::shared_ptr<Form> goal, std::shared_ptr<ErrorControl> control)
    ...
    .. cpp:function:: std::shared_ptr<const Function> solve_primal()
    ...
    .. cpp:function:: std::vector<std::shared_ptr<const DirichletBC> > extract_bcs() const
    ...
    .. cpp:function:: double evaluate_goal(Form& M, std::shared_ptr<const Function> u) const
    ...
    .. cpp:function:: void adapt_problem(std::shared_ptr<const Mesh> mesh)
    ...
    .. cpp:function:: void init(std::shared_ptr<NonlinearVariationalProblem> problem, std::shared_ptr<GoalFunctional> goal)
