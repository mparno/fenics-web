...
.. cpp:class:: Mesh
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: Mesh(std::shared_ptr<const CSGGeometry> geometry, std::size_t resolution)
    ...
    .. cpp:function:: std::shared_ptr<MeshDisplacement> move(BoundaryMesh& boundary)
    ...
    .. cpp:function:: std::shared_ptr<MeshDisplacement> move(Mesh& mesh)
