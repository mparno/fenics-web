...
.. cpp:class:: VTKPlotter
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: VTKPlotter(std::shared_ptr<const Variable>, QVTKWidget *widget = NULL)
    ...
    .. cpp:function:: VTKPlotter(std::shared_ptr<const Expression> expression, std::shared_ptr<const Mesh> mesh, QVTKWidget *wiget = NULL)
    ...
    .. cpp:function:: void plot(std::shared_ptr<const Variable> variable=std::shared_ptr<const Variable>())
