...
.. cpp:class:: GraphBuilder
    ...
    .. cpp:function:: static void compute_dual_graph(const MPI_Comm mpi_comm, const LocalMeshData& mesh_data, std::vector<std::set<std::size_t> >& local_graph, std::set<std::size_t>& ghost_vertices)
