...
.. cpp:class:: SystemAssembler
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: SystemAssembler(std::shared_ptr<const Form> a, std::shared_ptr<const Form> L)
    
        Constructor


    .. cpp:function:: SystemAssembler(std::shared_ptr<const Form> a, std::shared_ptr<const Form> L, const DirichletBC& bc)
    
        Constructor


    .. cpp:function:: SystemAssembler(std::shared_ptr<const Form> a, std::shared_ptr<const Form> L, const std::vector<const DirichletBC*> bcs)
