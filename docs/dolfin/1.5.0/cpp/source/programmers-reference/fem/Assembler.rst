...
.. cpp:class:: Assembler
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: void assemble_interior_facets(GenericTensor& A, const Form& a, UFC& ufc, std::shared_ptr<const MeshFunction<std::size_t> > domains, std::vector<double>* values)
