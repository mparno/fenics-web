...
.. cpp:class:: RectangleMesh
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: RectangleMesh(double x0, double y0, double x1, double y1, std::size_t nx, std::size_t ny, std::string diagonal="right")
    ...
    .. cpp:function:: RectangleMesh(MPI_Comm comm, double x0, double y0, double x1, double y1, std::size_t nx, std::size_t ny, std::string diagonal="right")
