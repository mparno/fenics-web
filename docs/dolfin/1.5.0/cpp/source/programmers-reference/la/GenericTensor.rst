...
.. cpp:class:: GenericTensor
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: void set_local(const double* block, const dolfin::la_index* num_rows, const dolfin::la_index * const * rows) = 0
    ...
    .. cpp:function:: void add_local(const double* block, const std::vector<const std::vector<dolfin::la_index>* >& rows) = 0
    ...
    .. cpp:function:: void add_local(const double* block, const std::vector<std::vector<dolfin::la_index> >& rows) = 0
    ...
    .. cpp:function:: void add_local(const double* block, const dolfin::la_index* num_rows, const dolfin::la_index * const * rows) = 0
