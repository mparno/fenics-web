...
.. cpp:class:: MeshColoring
    ...
    .. cpp:function:: static CellFunction<std::size_t> cell_colors(const Mesh& mesh, std::string coloring_type)
    
        Return a MeshFunction with the cell colors (used for visualisation)


    .. cpp:function:: static CellFunction<std::size_t> cell_colors(const Mesh& mesh, const std::vector<std::size_t> coloring_type)
