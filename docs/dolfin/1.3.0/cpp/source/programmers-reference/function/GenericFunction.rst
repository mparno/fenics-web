...
.. cpp:class:: GenericFunction
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: void restrict(double* w, const FiniteElement& element, const Cell& dolfin_cell, const double* vertex_coordinates, const ufc::cell& ufc_cell) const = 0
