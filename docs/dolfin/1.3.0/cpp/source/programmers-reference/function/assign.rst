...
.. cpp:function:: void assign(boost::shared_ptr<Function> receiving_func, boost::shared_ptr<const Function> assigning_func)
...
.. cpp:function:: void assign(boost::shared_ptr<Function> receiving_func, std::vector<boost::shared_ptr<const Function> > assigning_funcs)
...
.. cpp:function:: void assign(std::vector<boost::shared_ptr<Function> > receiving_funcs, boost::shared_ptr<const Function> assigning_func)
