...
.. cpp:class:: AdaptiveNonlinearVariationalSolver
    ...
    .. cpp:function:: AdaptiveNonlinearVariationalSolver(boost::shared_ptr<NonlinearVariationalProblem> problem, boost::shared_ptr<GoalFunctional> goal)
    ...
    .. cpp:function:: AdaptiveNonlinearVariationalSolver(boost::shared_ptr<NonlinearVariationalProblem> problem, boost::shared_ptr<Form> goal, boost::shared_ptr<ErrorControl> control)
    ...
    .. cpp:function:: void init(boost::shared_ptr<NonlinearVariationalProblem> problem, boost::shared_ptr<GoalFunctional> goal)
