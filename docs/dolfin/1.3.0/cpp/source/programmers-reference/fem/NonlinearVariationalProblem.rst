...
.. cpp:class:: NonlinearVariationalProblem
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: NonlinearVariationalProblem(boost::shared_ptr<const Form> F, boost::shared_ptr<Function> u, std::vector<boost::shared_ptr<const DirichletBC> > bcs)
    ...
    .. cpp:function:: NonlinearVariationalProblem(boost::shared_ptr<const Form> F, boost::shared_ptr<Function> u, std::vector<boost::shared_ptr<const DirichletBC> > bcs, boost::shared_ptr<const Form> J)
    ...
    .. cpp:function:: void set_bounds(boost::shared_ptr<const GenericVector> lb, boost::shared_ptr<const GenericVector> ub)
    ...
    .. cpp:function:: void set_bounds(boost::shared_ptr<const Function> lb_func, boost::shared_ptr<const Function> ub_func)
    ...
    .. cpp:function:: boost::shared_ptr<const GenericVector> lower_bound() const
    
        Return lower bound


    .. cpp:function:: boost::shared_ptr<const GenericVector> upper_bound() const
