...
.. cpp:class:: Form
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: boost::shared_ptr<const MeshFunction<std::size_t> > cell_domains() const
    ...
    .. cpp:function:: boost::shared_ptr<const MeshFunction<std::size_t> > exterior_facet_domains() const
    ...
    .. cpp:function:: boost::shared_ptr<const MeshFunction<std::size_t> > interior_facet_domains() const
