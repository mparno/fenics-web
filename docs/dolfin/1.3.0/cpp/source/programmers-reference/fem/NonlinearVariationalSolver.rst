...
.. cpp:class:: NonlinearVariationalSolver
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: std::pair<std::size_t, bool> solve(boost::shared_ptr<const GenericVector> lb, boost::shared_ptr<const GenericVector> ub)
    ...
    .. cpp:function:: std::pair<std::size_t, bool> solve(boost::shared_ptr<const Function> lb, boost::shared_ptr<const Function> ub)
