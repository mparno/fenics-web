...
.. cpp:class:: CCFEMForm
    ...
    .. cpp:function:: CCFEMForm(boost::shared_ptr<const CCFEMFunctionSpace> function_space)
    ...
    .. cpp:function:: CCFEMForm(boost::shared_ptr<const CCFEMFunctionSpace> function_space_0, boost::shared_ptr<const CCFEMFunctionSpace> function_space_1)
    ...
    .. cpp:function:: boost::shared_ptr<const Form> part(std::size_t i) const
    ...
    .. cpp:function:: boost::shared_ptr<const CCFEMFunctionSpace> function_space(std::size_t i) const
    ...
    .. cpp:function:: void add(boost::shared_ptr<const Form> form)
