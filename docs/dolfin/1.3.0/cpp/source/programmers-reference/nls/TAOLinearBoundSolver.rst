...
.. cpp:class:: TAOLinearBoundSolver
    ...
    *Example*
    ...
    .. cpp:function:: static PetscErrorCode __TAOFormFunctionGradientQuadraticProblem( TaoSolver tao, Vec X, PetscReal *ener, Vec G, void *ptr)
    
        Computes the value of the objective function and its gradient.


    .. cpp:function:: static PetscErrorCode __TAOFormHessianQuadraticProblem(TaoSolver tao,Vec X,Mat *H, Mat *Hpre, MatStructure *flg,   void *ptr)
