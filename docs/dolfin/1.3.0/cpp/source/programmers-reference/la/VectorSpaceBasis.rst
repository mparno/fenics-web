...
.. cpp:class:: VectorSpaceBasis
    ...
    .. cpp:function:: VectorSpaceBasis(const std::vector<boost::shared_ptr<GenericVector> > basis)
    ...
    .. cpp:function:: boost::shared_ptr<const GenericVector> operator[] (std::size_t i) const
