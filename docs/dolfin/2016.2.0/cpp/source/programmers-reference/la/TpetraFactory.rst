...
.. Documentation for the header file dolfin/la/TpetraFactory.h

.. _programmers_reference_cpp_la_tpetrafactory:
...
.. cpp:class:: TpetraFactory
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: static TpetraFactory& instance()
    
        Return singleton instance


    .. cpp:function:: TpetraFactory()
