...
.. Documentation for the header file dolfin/la/EigenKrylovSolver.h

.. _programmers_reference_cpp_la_eigenkrylovsolver:
...
.. cpp:class:: EigenKrylovSolver
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: EigenKrylovSolver(std::string method="default", std::string preconditioner="default")
    ...
    .. cpp:function:: void set_operators(std::shared_ptr<const EigenMatrix> A, std::shared_ptr<const EigenMatrix> P)
    
        Set operator (matrix) and preconditioner matrix


    .. cpp:function:: std::shared_ptr<const EigenMatrix> get_operator() const
    ...
    .. cpp:function:: std::size_t solve(EigenVector& x, const EigenVector& b)
