...
.. Documentation for the header file dolfin/la/EigenFactory.h

.. _programmers_reference_cpp_la_eigenfactory:
...
.. cpp:class:: EigenFactory
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: static EigenFactory& instance()
