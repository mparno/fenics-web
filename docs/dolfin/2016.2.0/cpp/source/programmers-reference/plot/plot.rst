...
.. cpp:function:: void plot(const Variable&, std::string title="", std::string mode="auto")
...
.. cpp:function:: void plot(const Variable&, const Parameters& parameters)
...
.. cpp:function:: void plot(const Expression& expression, const Mesh& mesh, std::string title="", std::string mode="auto")
...
.. cpp:function:: void plot(const Expression& expression, const Mesh& mesh, const Parameters& parameters)
