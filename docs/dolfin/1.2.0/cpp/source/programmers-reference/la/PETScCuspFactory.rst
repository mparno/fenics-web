...
.. Documentation for the header file dolfin/la/PETScCuspFactory.h

.. _programmers_reference_cpp_la_petsccuspfactory:
...
.. cpp:class:: PETScCuspFactory
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: static PETScCuspFactory& instance()
    
        Return singleton instance


    .. cpp:function:: PETScCuspFactory()
