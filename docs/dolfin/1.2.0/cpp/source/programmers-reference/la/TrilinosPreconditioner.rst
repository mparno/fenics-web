...
.. cpp:class:: TrilinosPreconditioner
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: void set_parameters(boost::shared_ptr<const Teuchos::ParameterList> list)
    ...
    .. cpp:function:: void set_nullspace(const std::vector<const GenericVector*> null_space)
