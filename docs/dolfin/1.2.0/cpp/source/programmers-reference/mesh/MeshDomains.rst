...
.. cpp:class:: MeshDomains
    ...
    .. cpp:function:: MeshDomains(Mesh& mesh)
    ...
    .. cpp:function:: boost::shared_ptr<const MeshFunction<std::size_t> > cell_domains(std::size_t unset_value=MeshDomains::default_unset_value) const
    ...
    .. cpp:function:: boost::shared_ptr<const MeshFunction<std::size_t> > facet_domains(std::size_t unset_value=MeshDomains::default_unset_value) const
    ...
    .. cpp:function:: boost::shared_ptr<MeshFunction<std::size_t> > mesh_function(const MeshValueCollection<std::size_t>& collection, std::size_t unset_value=MeshDomains::default_unset_value) const
