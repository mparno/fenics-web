...
.. cpp:class:: UmfpackLUSolver
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: UmfpackLUSolver(boost::shared_ptr<const GenericLinearOperator> A)
    ...
    .. cpp:function:: std::size_t solve_factorized(GenericVector& x, const GenericVector& b) const
