...
.. cpp:class:: GenericAdaptiveVariationalSolver
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: std::vector<boost::shared_ptr<AdaptiveDatum> > adaptive_data() const
    
        Return stored adaptive data
        
        *Returns*
           std::vector<:cpp:class:`AdaptiveDatum`>
    ...
    .. cpp:function:: bool stop(const FunctionSpace& V, const double error_estimate, const double tolerance)
    ...
    .. cpp:function:: void summary(const AdaptiveDatum& data)
