...
.. cpp:class:: FunctionSpace
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: boost::shared_ptr<const FiniteElement> element() const
    ...
    .. cpp:function:: boost::shared_ptr<const GenericDofMap> dofmap() const
    ...
    .. cpp:function:: boost::shared_ptr<FunctionSpace> operator[] (std::size_t i) const
    ...
    .. cpp:function:: boost::shared_ptr<FunctionSpace> extract_sub_space(const std::vector<std::size_t>& component) const
    ...
    .. cpp:function:: boost::shared_ptr<FunctionSpace> collapse(boost::unordered_map<std::size_t, std::size_t>& collapsed_dofs) const
