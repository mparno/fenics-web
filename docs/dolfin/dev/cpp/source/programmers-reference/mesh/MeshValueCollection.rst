...
.. cpp:class:: MeshValueCollection
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: explicit MeshValueCollection(boost::shared_ptr<const Mesh> mesh)
    ...
    .. cpp:function:: MeshValueCollection(boost::shared_ptr<const Mesh> mesh, std::size_t dim)
