...
.. cpp:class:: MeshFunction
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: explicit MeshFunction(boost::shared_ptr<const Mesh> mesh)
    ...
    .. cpp:function:: MeshFunction(boost::shared_ptr<const Mesh> mesh, std::size_t dim)
    ...
    .. cpp:function:: MeshFunction(boost::shared_ptr<const Mesh> mesh, std::size_t dim, const T& value)
    ...
    .. cpp:function:: MeshFunction(boost::shared_ptr<const Mesh> mesh, const std::string filename)
    ...
    .. cpp:function:: MeshFunction(boost::shared_ptr<const Mesh> mesh, const MeshValueCollection<T>& value_collection)
    ...
    .. cpp:function:: MeshFunction(boost::shared_ptr<const Mesh> mesh, std::size_t dim, const MeshDomains& domains)
    ...
    .. cpp:function:: void init(boost::shared_ptr<const Mesh> mesh, std::size_t dim)
    ...
    .. cpp:function:: void init(boost::shared_ptr<const Mesh> mesh, std::size_t dim, std::size_t size)
