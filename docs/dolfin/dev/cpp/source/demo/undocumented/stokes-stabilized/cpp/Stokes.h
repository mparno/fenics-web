...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    G[6] = 0.800000000000000*W1*circumradius*circumradius*det*(K_00*K_10 + K_01*K_11);
    G[7] = W1*det*(K_00*K_00 + K_01*K_01);
    G[8] = 0.800000000000000*W1*circumradius*circumradius*det*(K_00*K_00 + K_01*K_01);
    G[9] = 0.800000000000000*W1*circumradius*circumradius*det*(K_10*K_10 + K_11*K_11);
    G[10] =  - K_10*W1*det;
    G[11] =  - K_11*W1*det;
    G[12] =  - K_01*W1*det;
    G[13] =  - K_00*W1*det;
    ...
    for (unsigned int j = 0; j < 3; j++)
    {
      for (unsigned int k = 0; k < 2; k++)
      {
        ...
        A[nzc6[j]*9 + nzc5[k]] += FE0_C0[0][j]*FE0_C0_D01[0][k]*G[0];
        // Number of operations to compute entry: 3
        A[nzc6[j]*9 + nzc4[k]] += FE0_C0[0][j]*FE0_C0_D01[0][k]*G[1];
        // Number of operations to compute entry: 3
        A[nzc6[j]*9 + nzc2[k]] += FE0_C0[0][j]*FE0_C0_D01[0][k]*G[2];
        // Number of operations to compute entry: 3
        A[nzc6[j]*9 + nzc1[k]] += FE0_C0[0][j]*FE0_C0_D01[0][k]*G[3];
      }// end loop over 'k'
    }// end loop over 'j'
    ...
    for (unsigned int j = 0; j < 2; j++)
    {
      ...
      {
        // Number of operations to compute entry: 3
        A[nzc2[j]*9 + nzc1[k]] += FE0_C0_D01[0][j]*FE0_C0_D01[0][k]*G[4];
        // Number of operations to compute entry: 3
        A[nzc1[j]*9 + nzc1[k]] += FE0_C0_D01[0][j]*FE0_C0_D01[0][k]*G[5];
        // Number of operations to compute entry: 3
        A[nzc1[j]*9 + nzc2[k]] += FE0_C0_D01[0][j]*FE0_C0_D01[0][k]*G[4];
        // Number of operations to compute entry: 3
        A[nzc5[j]*9 + nzc4[k]] += FE0_C0_D01[0][j]*FE0_C0_D01[0][k]*G[4];
        // Number of operations to compute entry: 3
        A[nzc4[j]*9 + nzc4[k]] += FE0_C0_D01[0][j]*FE0_C0_D01[0][k]*G[5];
        // Number of operations to compute entry: 3
        A[nzc8[j]*9 + nzc7[k]] += FE0_C0_D01[0][j]*FE0_C0_D01[0][k]*G[6];
        // Number of operations to compute entry: 3
        A[nzc4[j]*9 + nzc5[k]] += FE0_C0_D01[0][j]*FE0_C0_D01[0][k]*G[4];
        // Number of operations to compute entry: 3
        A[nzc2[j]*9 + nzc2[k]] += FE0_C0_D01[0][j]*FE0_C0_D01[0][k]*G[7];
        // Number of operations to compute entry: 3
        A[nzc5[j]*9 + nzc5[k]] += FE0_C0_D01[0][j]*FE0_C0_D01[0][k]*G[7];
        // Number of operations to compute entry: 3
        A[nzc8[j]*9 + nzc8[k]] += FE0_C0_D01[0][j]*FE0_C0_D01[0][k]*G[8];
        // Number of operations to compute entry: 3
        A[nzc7[j]*9 + nzc8[k]] += FE0_C0_D01[0][j]*FE0_C0_D01[0][k]*G[6];
        // Number of operations to compute entry: 3
        A[nzc7[j]*9 + nzc7[k]] += FE0_C0_D01[0][j]*FE0_C0_D01[0][k]*G[9];
      }// end loop over 'k'
    }// end loop over 'j'
    ...
    for (unsigned int j = 0; j < 2; j++)
    {
      ...
      {
        // Number of operations to compute entry: 3
        A[nzc1[j]*9 + nzc6[k]] += FE0_C0[0][k]*FE0_C0_D01[0][j]*G[10];
        // Number of operations to compute entry: 3
        A[nzc4[j]*9 + nzc6[k]] += FE0_C0[0][k]*FE0_C0_D01[0][j]*G[11];
        // Number of operations to compute entry: 3
        A[nzc5[j]*9 + nzc6[k]] += FE0_C0[0][k]*FE0_C0_D01[0][j]*G[12];
        // Number of operations to compute entry: 3
        A[nzc2[j]*9 + nzc6[k]] += FE0_C0[0][k]*FE0_C0_D01[0][j]*G[13];
      }// end loop over 'k'
    }// end loop over 'j'
  }
...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    for (unsigned int ip = 0; ip < 3; ip++)
    {
      ...
      I[2] = W3[ip]*(F0*G[0] + F1*G[1]);
      
      // Number of operations: 4
      I[3] = W3[ip]*(F0*G[2] + F1*G[3]);
      ...
      for (unsigned int j = 0; j < 3; j++)
      {
        ...
        A[nzc2[j]] += FE0_C0[ip][j]*I[0];
        // Number of operations to compute entry: 2
        A[nzc5[j]] += FE0_C0[ip][j]*I[1];
      }// end loop over 'j'
      ...
      {
        // Number of operations to compute entry: 2
        A[nzc9[j]] += FE1_C0_D01[ip][j]*I[2];
        // Number of operations to compute entry: 2
        A[nzc10[j]] += FE1_C0_D01[ip][j]*I[3];
      }// end loop over 'j'
    }// end loop over 'ip'
  }
...
public:
  ...
  virtual const char* signature() const
  {
    return "Form([Integral(IndexSum(Product(Indexed(Coefficient(VectorElement('Lagrange', Cell('triangle', Space(2)), 1, 2, None), 0), MultiIndex((Index(0),), {Index(0): 2})), Indexed(Sum(ComponentTensor(Product(Indexed(ComponentTensor(Indexed(SpatialDerivative(Argument(MixedElement(*[VectorElement('Lagrange', Cell('triangle', Space(2)), 1, 2, None), FiniteElement('Lagrange', Cell('triangle', Space(2)), 1, None)], **{'value_shape': (3,) }), 0), MultiIndex((Index(1),), {Index(1): 2})), MultiIndex((FixedIndex(2),), {})), MultiIndex((Index(1),), {Index(1): 2})), MultiIndex((Index(2),), {Index(2): 2})), Product(Product(FloatValue(2.000000000000000, (), (), {}), Circumradius(Cell('triangle', Space(2)))), Product(FloatValue(0.200000000000000, (), (), {}), Product(FloatValue(2.000000000000000, (), (), {}), Circumradius(Cell('triangle', Space(2))))))), MultiIndex((Index(2),), {Index(2): 2})), ListTensor(Indexed(Argument(MixedElement(*[VectorElement('Lagrange', Cell('triangle', Space(2)), 1, 2, None), FiniteElement('Lagrange', Cell('triangle', Space(2)), 1, None)], **{'value_shape': (3,) }), 0), MultiIndex((FixedIndex(0),), {FixedIndex(0): 3})), Indexed(Argument(MixedElement(*[VectorElement('Lagrange', Cell('triangle', Space(2)), 1, 2, None), FiniteElement('Lagrange', Cell('triangle', Space(2)), 1, None)], **{'value_shape': (3,) }), 0), MultiIndex((FixedIndex(1),), {FixedIndex(1): 3})))), MultiIndex((Index(0),), {Index(0): 2}))), MultiIndex((Index(0),), {Index(0): 2})), Measure('cell', 0, None))])";
  }
...
public:
  ...
  Form_0_FunctionSpace_0(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          ...
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dofmap>(new stokes_dofmap_2()), mesh)))
  {
    // Do nothing
  }
