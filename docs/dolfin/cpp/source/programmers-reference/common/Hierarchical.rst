...
.. cpp:class:: Hierarchical
    ...
    .. cpp:function:: const T& coarse() const
    
        Return coarsest object in hierarchy (const version).


    .. cpp:function:: boost::shared_ptr<T> coarse_shared_ptr()
    ...
    .. cpp:function:: boost::shared_ptr<const T> coarse_shared_ptr() const
    ...
    .. cpp:function:: const T& fine() const
    
        Return finest object in hierarchy (const version).


    .. cpp:function:: boost::shared_ptr<T> fine_shared_ptr()
    ...
    .. cpp:function:: boost::shared_ptr<const T> fine_shared_ptr() const
