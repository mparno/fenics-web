...
.. cpp:class:: PeriodicBC
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: boost::shared_ptr<const SubDomain> sub_domain() const
    ...
    .. cpp:function:: std::vector<std::pair<std::pair<std::size_t, std::size_t>, std::pair<std::size_t, std::size_t> > > compute_dof_pairs() const
    
        Compute dof pairs (master dof, slave dof)


    .. cpp:function:: void compute_dof_pairs(std::vector<std::pair<std::pair<std::size_t, std::size_t>, std::pair<std::size_t, std::size_t> > >& dof_pairs) const
