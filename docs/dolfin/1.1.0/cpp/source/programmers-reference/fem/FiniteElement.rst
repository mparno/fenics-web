...
.. cpp:class:: FiniteElement
    ...
    .. cpp:function:: void evaluate_basis(std::size_t i, double* values, const double* x, const ufc::cell& cell) const
    ...
    .. cpp:function:: double evaluate_dof(std::size_t i, const ufc::function& function, const ufc::cell& cell) const
    ...
    .. cpp:function:: void evaluate_basis(std::size_t i, double* values, const double* x, const Cell& cell) const
