...
.. cpp:function:: void solve(const Equation& equation, Function& u, const BoundaryCondition& bc, Parameters parameters=empty_parameters)
...
.. cpp:function:: void solve(const Equation& equation, Function& u, std::vector<const BoundaryCondition*> bcs, Parameters parameters=empty_parameters)
...
.. cpp:function:: void solve(const Equation& equation, Function& u, const BoundaryCondition& bc, const Form& J, Parameters parameters=empty_parameters)
...
.. cpp:function:: void solve(const Equation& equation, Function& u, std::vector<const BoundaryCondition*> bcs, const Form& J, Parameters parameters=empty_parameters)
