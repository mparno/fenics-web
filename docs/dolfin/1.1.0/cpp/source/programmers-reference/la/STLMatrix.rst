...
.. cpp:class:: STLMatrix
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: void csr(std::vector<double>& vals, std::vector<T>& cols, std::vector<T>& row_ptr, std::vector<T>& local_to_global_row, bool symmetric) const
    
        Return matrix in CSR format


    .. cpp:function:: void csc(std::vector<double>& vals, std::vector<T>& rows, std::vector<T>& col_ptr, std::vector<T>& local_to_global_col, bool symmetric) const
    ...
    .. cpp:function:: void compressed_storage(std::vector<double>& vals, std::vector<T>& rows, std::vector<T>& col_ptr, std::vector<T>& local_to_global_col, bool symmetric) const
