...
.. cpp:class:: BlockMatrix
    ...
    .. cpp:function:: void set_block(std::size_t i, std::size_t j, boost::shared_ptr<GenericMatrix> m)
    
        Set block


    .. cpp:function:: const boost::shared_ptr<GenericMatrix> get_block(std::size_t i, std::size_t j) const
    
        Get block (const version)


    .. cpp:function:: boost::shared_ptr<GenericMatrix> get_block(std::size_t i, std::size_t j)
