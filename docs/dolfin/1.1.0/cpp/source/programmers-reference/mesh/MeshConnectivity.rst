...
.. cpp:class:: MeshConnectivity
    ...
    .. cpp:function:: const std::size_t* operator() (std::size_t entity) const
    
        Return array of connections for given entity


    .. cpp:function:: const std::vector<std::size_t>& operator() () const
    ...
    .. cpp:function:: void set_global_size(const std::vector<std::size_t>& num_global_connections)
