...
.. cpp:class:: SubDomain
    ...
    .. cpp:function:: void mark_cells(Mesh& mesh, std::size_t sub_domain) const
    ...
    .. cpp:function:: void mark_facets(Mesh& mesh, std::size_t sub_domain) const
    ...
    .. cpp:function:: void mark(Mesh& mesh, std::size_t dim, std::size_t sub_domain) const
    ...
    .. cpp:function:: void mark(MeshFunction<std::size_t>& sub_domains, std::size_t sub_domain) const
    ...
    .. cpp:function:: void mark(MeshValueCollection<std::size_t>& sub_domains, std::size_t sub_domain, const Mesh& mesh) const
