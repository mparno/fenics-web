...
.. cpp:class:: Mesh
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: explicit Mesh(const CSGGeometry& geometry, std::size_t mesh_resolution)
    ...
    .. cpp:function:: explicit Mesh(boost::shared_ptr<const CSGGeometry> geometry, std::size_t resolution)
    ...
    .. cpp:function:: const std::vector<std::size_t>& cells() const
