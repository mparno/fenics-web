...
.. cpp:class:: VTKPlotter
    ...
    *Parent class(es)*
    ...
    .. cpp:function:: explicit VTKPlotter(boost::shared_ptr<const Variable>, QVTKWidget *widget = NULL)
    ...
    .. cpp:function:: explicit VTKPlotter(boost::shared_ptr<const Expression> expression, boost::shared_ptr<const Mesh> mesh, QVTKWidget *wiget = NULL)
