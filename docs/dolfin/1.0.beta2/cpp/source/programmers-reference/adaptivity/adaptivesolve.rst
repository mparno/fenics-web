...
.. cpp:function:: void solve(const Equation& equation, Function& u, const BoundaryCondition& bc, const double tol, GoalFunctional& M)

    Solve linear variational problem a(u, v) == L(v) with single
    boundary condition


.. cpp:function:: void solve(const Equation& equation, Function& u, std::vector<const BoundaryCondition*> bcs, const double tol, GoalFunctional& M)
...
.. cpp:function:: void solve(const Equation& equation, Function& u, const BoundaryCondition& bc, const Form& J, const double tol, GoalFunctional& M)

    Solve linear variational problem F(u; v) = 0 with single
    boundary condition


.. cpp:function:: void solve(const Equation& equation, Function& u, std::vector<const BoundaryCondition*> bcs, const Form& J, const double tol, GoalFunctional& M)
