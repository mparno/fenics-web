...
.. cpp:class:: SystemAssembler
    ...
    .. cpp:function:: static void assemble(GenericMatrix& A, GenericVector& b, const Form& a, const Form& L, bool reset_sparsity=true, bool add_values=false, bool finalize_tensor=true)
    
        Assemble system (A, b)


    .. cpp:function:: static void assemble(GenericMatrix& A, GenericVector& b, const Form& a, const Form& L, const DirichletBC& bc, bool reset_sparsity=true, bool add_values=true, bool finalize_tensor=true)
    
        Assemble system (A, b) and apply Dirichlet boundary condition


    .. cpp:function:: static void assemble(GenericMatrix& A, GenericVector& b, const Form& a, const Form& L, const std::vector<const DirichletBC*>& bcs, bool reset_sparsity=true, bool add_values=false, bool finalize_tensor=true)
