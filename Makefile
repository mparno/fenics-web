...
clean:
	-rm -rf build/* *~ source/*~ source/_static/*~ source/_templates/*~ source/demos/*~ source/demos/cpp/*~ source/demos/cpp/pde/*~ source/demos/python/*~ source/demos/python/pde/*~ source/tutorial/*~ source/tutorial/cpp/*~ source/tutorial/python/*~ source/user-manual/*~ source/user-manual/cpp/*~ source/user-manual/python/*~ source/user-manual/appendices/*~ source/user-manual/appendices/ffc/*~ source/user-manual/appendices/ufc/*~ source/user-manual/appendices/ufl/*~
