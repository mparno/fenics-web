...
.. title:: Documentation for 1.0-rc2

####################################################
Documentation for FEniCS 1.0-rc2
####################################################
...
(*This page accesses the FEniCS 1.0-rc2 documentation. Not the
...
* `Documented DOLFIN demos (Python) <../documentation/dolfin/1.0.rc2/python/demo/index.html>`__
* `Documented DOLFIN demos (C++) <../documentation/dolfin/1.0.rc2/cpp/demo/index.html>`__
...
* `Basic classes and functions in DOLFIN (Python) <../documentation/dolfin/1.0.rc2/python/quick_reference.html>`__
* `Basic classes and functions in DOLFIN  (C++) <../documentation/dolfin/1.0.rc2/cpp/quick_reference.html>`__
...
* `All classes and functions in DOLFIN (Python) <../documentation/dolfin/1.0.rc2/python/genindex.html>`__
* `All classes and functions in DOLFIN (C++) <../documentation/dolfin/1.0.rc2/cpp/genindex.html>`__
