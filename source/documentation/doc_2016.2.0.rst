...
.. title:: Documentation for 2016.2.0

####################################################
Documentation for FEniCS 2016.2.0
####################################################
...
(*This page accesses the FEniCS 2016.2.0 documentation. Not the
...
A good starting point for new users is the `FEniCS Tutorial
...
* `Documented DOLFIN demos (Python) <../documentation/dolfin/2016.2.0/python/demo/index.html>`__
* `Documented DOLFIN demos (C++) <../documentation/dolfin/2016.2.0/cpp/demo/index.html>`__
...
* `Basic classes and functions in DOLFIN (Python) <../documentation/dolfin/2016.2.0/python/quick_reference.html>`__
* `Basic classes and functions in DOLFIN  (C++) <../documentation/dolfin/2016.2.0/cpp/quick_reference.html>`__
...
* `All classes and functions in DOLFIN (Python) <../documentation/dolfin/2016.2.0/python/genindex.html>`__
* `All classes and functions in DOLFIN (C++) <../documentation/dolfin/2016.2.0/cpp/genindex.html>`__
* `All classes and functions in UFL <http://fenics-ufl.readthedocs.io/en/2016.2.0/api-doc/ufl.html>`__
