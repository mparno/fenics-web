...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    // Total number of operations (multiply-add pairs):                  39
    ...
    A[0] = 0.499999999999999*G0_0_0 + 0.499999999999999*G0_0_1 + 0.499999999999999*G0_1_0 + 0.499999999999999*G0_1_1 + 0.083333333333333*G1_;
    A[1] = -0.499999999999999*G0_0_0 - 0.499999999999999*G0_1_0 + 0.041666666666667*G1_;
    A[2] = -0.499999999999999*G0_0_1 - 0.499999999999999*G0_1_1 + 0.041666666666667*G1_;
    A[3] = -0.499999999999999*G0_0_0 - 0.499999999999999*G0_0_1 + 0.041666666666667*G1_;
    A[4] = 0.499999999999999*G0_0_0 + 0.083333333333333*G1_;
    A[5] = 0.499999999999999*G0_0_1 + 0.041666666666667*G1_;
    A[6] = -0.499999999999999*G0_1_0 - 0.499999999999999*G0_1_1 + 0.041666666666667*G1_;
    A[7] = 0.499999999999999*G0_1_0 + 0.041666666666667*G1_;
...
public:
  ...
  virtual const char* signature() const
  {
    return "Form([Integral(IndexSum(Product(Indexed(ComponentTensor(SpatialDerivative(Argument(FiniteElement('Lagrange', Cell('triangle', 1, Space(2)), 1), 0), MultiIndex((Index(0),), {Index(0): 2})), MultiIndex((Index(0),), {Index(0): 2})), MultiIndex((Index(1),), {Index(1): 2})), Indexed(ComponentTensor(SpatialDerivative(Argument(FiniteElement('Lagrange', Cell('triangle', 1, Space(2)), 1), 1), MultiIndex((Index(2),), {Index(2): 2})), MultiIndex((Index(2),), {Index(2): 2})), MultiIndex((Index(1),), {Index(1): 2}))), MultiIndex((Index(1),), {Index(1): 2})), Measure('cell', 0, None)), Integral(Product(Argument(FiniteElement('Lagrange', Cell('triangle', 1, Space(2)), 1), 0), Argument(FiniteElement('Lagrange', Cell('triangle', 1, Space(2)), 1), 1)), Measure('cell', 0, None))])";
  }
...
public:
  ...
  virtual const char* signature() const
  {
    return "Form([Integral(Product(Argument(FiniteElement('Lagrange', Cell('triangle', 1, Space(2)), 1), 0), Coefficient(FiniteElement('Lagrange', Cell('triangle', 1, Space(2)), 1), 0)), Measure('cell', 0, None))])";
  }
