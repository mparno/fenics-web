...
class drag_dof_map_0: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  drag_dof_map_0() : ufc::dof_map()
  {
    _global_dimension = 0;
  }

  /// Destructor
  virtual ~drag_dof_map_0()
  {
    // Do nothing
  }
...
public:
  ...
  CoefficientSpace_p(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          ...
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new drag_dof_map_0()), mesh)))
  {
    // Do nothing
  }
