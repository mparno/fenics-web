...
class currentdensity_dof_map_0: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  currentdensity_dof_map_0() : ufc::dof_map()
  {
    _global_dimension = 0;
  }

  /// Destructor
  virtual ~currentdensity_dof_map_0()
  {
    // Do nothing
  }
...
class currentdensity_dof_map_1: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  currentdensity_dof_map_1() : ufc::dof_map()
  {
    _global_dimension = 0;
  }

  /// Destructor
  virtual ~currentdensity_dof_map_1()
  {
    // Do nothing
  }
...
class currentdensity_dof_map_2: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  currentdensity_dof_map_2() : ufc::dof_map()
  {
    _global_dimension = 0;
  }

  /// Destructor
  virtual ~currentdensity_dof_map_2()
  {
    // Do nothing
  }
  ...
  virtual ufc::dof_map* create_sub_dof_map(unsigned int i) const
  {
    ...
    case 0:
      {
        return new currentdensity_dof_map_1();
        break;
      }
    case 1:
      {
...
public:
  ...
  virtual ufc::dof_map* create_dof_map(unsigned int i) const
  {
    ...
    case 0:
      {
        return new currentdensity_dof_map_2();
        break;
      }
    case 1:
      {
...
public:
  ...
  virtual ufc::dof_map* create_dof_map(unsigned int i) const
  {
    ...
    case 1:
      {
        return new currentdensity_dof_map_0();
        break;
      }
    }
...
public:
  ...
  CoefficientSpace_T(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          ...
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new currentdensity_dof_map_0()), mesh)))
  {
    // Do nothing
  }
...
public:
  ...
  Form_0_FunctionSpace_0(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          ...
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new currentdensity_dof_map_2()), mesh)))
  {
    // Do nothing
  }
