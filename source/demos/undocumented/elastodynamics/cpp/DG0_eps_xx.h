...
class dg0_eps_xx_dof_map_0: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  dg0_eps_xx_dof_map_0() : ufc::dof_map()
  {
    _global_dimension = 0;
  }

  /// Destructor
  virtual ~dg0_eps_xx_dof_map_0()
  {
    // Do nothing
  }
...
class dg0_eps_xx_dof_map_1: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  dg0_eps_xx_dof_map_1() : ufc::dof_map()
  {
    _global_dimension = 0;
  }

  /// Destructor
  virtual ~dg0_eps_xx_dof_map_1()
  {
    // Do nothing
  }
  ...
  virtual ufc::dof_map* create_sub_dof_map(unsigned int i) const
  {
    ...
    case 0:
      {
        return new dg0_eps_xx_dof_map_0();
        break;
      }
    case 1:
      {
...
class dg0_eps_xx_dof_map_2: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  dg0_eps_xx_dof_map_2() : ufc::dof_map()
  {
    _global_dimension = 0;
  }

  /// Destructor
  virtual ~dg0_eps_xx_dof_map_2()
  {
    // Do nothing
  }
...
class dg0_eps_xx_cell_integral_0_0: public ufc::cell_integral
{
public:

  /// Constructor
  dg0_eps_xx_cell_integral_0_0() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~dg0_eps_xx_cell_integral_0_0()
  {
    // Do nothing
  }
...
class dg0_eps_xx_cell_integral_1_0: public ufc::cell_integral
{
public:

  /// Constructor
  dg0_eps_xx_cell_integral_1_0() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~dg0_eps_xx_cell_integral_1_0()
  {
    // Do nothing
  }
                               ...
                               const ufc::cell& c) const
  {
    ...
    // Compute geometry tensor
    const double G0_0_0 = det*w[0][0]*K_00*(1.0);
    const double G0_0_1 = det*w[0][0]*K_10*(1.0);
    const double G0_1_0 = det*w[0][1]*K_00*(1.0);
    const double G0_2_1 = det*w[0][2]*K_10*(1.0);
    
    // Compute element tensor
    A[0] = -0.500000000000000*G0_0_0 - 0.500000000000000*G0_0_1 + 0.500000000000000*G0_1_0 + 0.500000000000000*G0_2_1;
  }
...
public:
  ...
  virtual ufc::dof_map* create_dof_map(unsigned int i) const
  {
    ...
    case 0:
      {
        return new dg0_eps_xx_dof_map_2();
        break;
      }
    case 1:
      {
  ...
  virtual ufc::cell_integral* create_cell_integral(unsigned int i) const
  {
    ...
    case 0:
      {
        return new dg0_eps_xx_cell_integral_0_0();
        break;
      }
    }
...
public:
  ...
  virtual ufc::dof_map* create_dof_map(unsigned int i) const
  {
    ...
    case 1:
      {
        return new dg0_eps_xx_dof_map_1();
        break;
      }
    }
  ...
  virtual ufc::cell_integral* create_cell_integral(unsigned int i) const
  {
    ...
    case 0:
      {
        return new dg0_eps_xx_cell_integral_1_0();
        break;
      }
    }
...
public:
  ...
  CoefficientSpace_u(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new dg0_eps_xx_finite_element_1()))),
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new dg0_eps_xx_dof_map_1()), mesh)))
  {
    // Do nothing
  }
...
public:
  ...
  Form_0_FunctionSpace_0(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new dg0_eps_xx_finite_element_2()))),
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new dg0_eps_xx_dof_map_2()), mesh)))
  {
    // Do nothing
  }
...
public:
    ...
    dolfin::Form(2, 0)
  {
    ...
    _ufc_form = boost::shared_ptr<const ufc::form>(new dg0_eps_xx_form_0());
  }
...
public:
    ...
    dolfin::Form(1, 1), u(*this, 0)
  {
    ...
    _ufc_form = boost::shared_ptr<const ufc::form>(new dg0_eps_xx_form_1());
  }

  // Constructor
  Form_1(const dolfin::FunctionSpace& V0, const dolfin::GenericFunction& u):
    dolfin::Form(1, 1), u(*this, 0)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
  ...
  // Constructor
  Form_1(const dolfin::FunctionSpace& V0, boost::shared_ptr<const dolfin::GenericFunction> u):
    dolfin::Form(1, 1), u(*this, 0)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
  ...
  // Constructor
  Form_1(boost::shared_ptr<const dolfin::FunctionSpace> V0, const dolfin::GenericFunction& u):
    dolfin::Form(1, 1), u(*this, 0)
  {
    _function_spaces[0] = V0;
  ...
  // Constructor
  Form_1(boost::shared_ptr<const dolfin::FunctionSpace> V0, boost::shared_ptr<const dolfin::GenericFunction> u):
    dolfin::Form(1, 1), u(*this, 0)
  {
    _function_spaces[0] = V0;
