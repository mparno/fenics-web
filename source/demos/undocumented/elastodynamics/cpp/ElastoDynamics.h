...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    G[1] = det*(w[7][0]*((w[13][0] - w[11][0]*w[13][0])/w[12][0]-1.000000000000000) + (w[6][0] - w[10][0]*w[6][0])/(w[12][0]*w[14][0]));
    G[2] = det*(w[14][0]*w[7][0]*(w[11][0]-1.000000000000000) + (0.500000000000000*w[13][0]*w[14][0]*w[7][0] + 0.500000000000000*w[6][0]-0.500000000000000*w[10][0]*w[6][0]-0.500000000000000*w[11][0]*w[13][0]*w[14][0]*w[7][0])/w[12][0] - w[6][0]);
    G[3] = det*w[11][0]*(K_00*K_10*( - w[8][0]-2.000000000000000*w[9][0]) - K_01*K_11*w[9][0]);
    G[4] = det*w[11][0]*(K_00*K_00*( - w[8][0]-2.000000000000000*w[9][0]) - K_01*K_01*w[9][0]);
    G[5] =  - det*w[11][0]*(K_00*K_11*w[8][0] + K_01*K_10*w[9][0]);
    G[6] =  - K_00*K_01*det*w[11][0]*(w[8][0] + w[9][0]);
    G[7] =  - det*w[11][0]*(K_00*K_11*w[9][0] + K_01*K_10*w[8][0]);
    G[8] = det*w[11][0]*(K_01*K_11*( - w[8][0]-2.000000000000000*w[9][0]) - K_00*K_10*w[9][0]);
    G[9] = det*w[11][0]*(K_01*K_01*( - w[8][0]-2.000000000000000*w[9][0]) - K_00*K_00*w[9][0]);
    ...
    for (unsigned int ip = 0; ip < 4; ip++)
    {
      ...
      I[0] = W4[ip]*(F1*det + F11*G[0] + F7*G[2] + F9*G[1]);
      
      // Number of operations: 8
      I[1] = W4[ip]*(F0*det + F10*G[0] + F6*G[2] + F8*G[1]);
      
      // Number of operations: 8
      I[2] = W4[ip]*(F2*G[4] + F3*G[3] + F4*G[6] + F5*G[5]);
      
      // Number of operations: 8
      I[3] = W4[ip]*(F2*G[6] + F3*G[7] + F4*G[9] + F5*G[8]);
      
      // Number of operations: 8
      I[4] = W4[ip]*(F2*G[5] + F3*G[10] + F4*G[8] + F5*G[11]);
      
      // Number of operations: 8
      I[5] = W4[ip]*(F2*G[3] + F3*G[12] + F4*G[7] + F5*G[10]);
