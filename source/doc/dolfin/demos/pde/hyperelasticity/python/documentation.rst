...
This demo is implemented in a single Python file, :download:`demo_hyperelasticity.py`,
...
This demo is implemented in the :download:`demo_hyperelasticity.py` file.
